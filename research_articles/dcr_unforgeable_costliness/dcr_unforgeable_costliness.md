...
The remainder of this paper will explore the ***Unforgeable Costliness*** of **Bitcoin** and **Decred** in the following areas:
...
**Gold**, due to its atomic properties is of extremely low abundance relative to other commodities. Its existence and supply is a product of the laws of physics and thus may only be acquired via physical exploration and extraction or by purchasing it off the market. This manifests as a natural constraint on supply inflation given the demands of production and leads to a convergence on gold as the monetary base for civilisations throughout human history.

Industrial uses represent a small fraction of global demand and it is reasonable to conclude that gold's intrinsic scarcity and subsequent monetary premium through history underlies demand for jewelry, rather than the other way around.
...
The evidence strongly suggests Satoshi deliberately reduced his share of network hashrate over time as new miners entered and Bitcoin gained strength. Thus **Bitcoin's** genesis is considered by many to be as fair as a decentralised scarce asset network launch could be.
...
**Decred** launched on 8 Feb 2016 at which time the cryptocurrency market had reached a state of maturity. **Bitcoin** had attained a market valuation over $6 billion and the market had significantly more participants and eyes (of friends and foes) than at the time of **Bitcoin's** launch. On one hand, these market conditions can benefit coin price appreciation whilst on the other pose challenges for bootstrapping security without compromising a 'fair initial distribution'.
...
2. No DCR mined via Proof-of-Work or the Treasury entered the stake pool (meaning the pre-mined coins are the only ones that have ever participated in staking)
...
As such, **Decreds's** initial distribution iterated on **Bitcoin's** ideals to account for the new market dynamics and need to bootstrap the Hybrid PoW/PoS consensus mechanism:
